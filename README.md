...
```
npm create cloudflare@latest -- --template=cloudflare/templates/jolly-thunder-41b5
```

A live public deployment of this template is available at [https://jolly-thunder-41b5.templates.workers.dev](https://jolly-thunder-41b5.templates.workers.dev)
